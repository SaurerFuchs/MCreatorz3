...
public class UnderworldTeleporter implements ITeleporter {
	...
	public static void registerPointOfInterest(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.POI_TYPES, registerHelper -> {
			PoiType poiType = new PoiType(ImmutableSet.copyOf(GhostsandgravesModBlocks.UNDERWORLD_PORTAL.get().getStateDefinition().getPossibleStates()), 0, 1);
	...
	public Optional<BlockUtil.FoundRectangle> createPortal(BlockPos p_77667_, Direction.Axis p_77668_) {
		...
		BlockState blockstate = GhostsandgravesModBlocks.UNDERWORLD_PORTAL.get().defaultBlockState().setValue(NetherPortalBlock.AXIS, p_77668_);
